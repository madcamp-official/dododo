...
export const commandCatalog: CommandDefinition[] = [
  ...
  { name: "watch", description: "주기 동기화와 알림을 실행합니다 (기본 1회, --loop로 지속, --interval <seconds>)", owner: "runtime", status: "ready" },
  ...
  { name: "advise", description: "현재 화면과 Context를 바탕으로 조언합니다 (--screen)", owner: "runtime", status: "ready" },
